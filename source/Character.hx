	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'box': //just copy and pasted Pico's case lol
				tex = Paths.getSparrowAtlas('box','shared',true);
				frames = tex;
				animation.addByPrefix('idle', "Box Idle Dance", 24);
				animation.addByPrefix('singUP', 'box Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'Box Down Note0', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'Box NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHT', 'Box Note Right0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'Box Note Right Miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'Box NOTE LEFT miss', 24, false);
				}
				else
				{
					// Need to be flipped! REDO THIS LATER!
					animation.addByPrefix('singLEFT', 'Box Note Right0', 24, false);
					animation.addByPrefix('singRIGHT', 'Box NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'Box NOTE LEFT miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'Box Note Right Miss', 24, false);
				}

				animation.addByPrefix('singUPmiss', 'box Up note miss', 24);
				animation.addByPrefix('singDOWNmiss', 'Box Down Note MISS', 24);
				...
				flipX = true;
			case 'annie': // again, copy and pasted lol
				tex = Paths.getSparrowAtlas('annie','shared',true);
				frames = tex;
				animation.addByPrefix('idle', "Pico Idle Dance", 24);
				animation.addByPrefix('singUP', 'pico Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'Pico Down Note0', 24, false);
			...
			case 'kapi':
				...
				playAnim('idle');
			case 'gw':
				tex = Paths.getSparrowAtlas('gw','shared',true);
				frames = tex;
				animation.addByPrefix('singUP', 'spooky UP NOTE', 24, false);
				animation.addByPrefix('singDOWN', 'spooky DOWN note', 24, false);
				animation.addByPrefix('singLEFT', 'note sing left', 24, false);
				...
				loadOffsetFile(curCharacter);
				// for fuck sakes why the hell do I have to change this just for G&W?????? JUST USE THE SAME FUCKING CODE AS SPOOKY KIDS
				playAnim('idle');
			case 'kapi-angy':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('kapi-angy','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
