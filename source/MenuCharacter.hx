...
class MenuCharacter extends FlxSprite
{
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		loadImage('campaign_menu_UI_characters');
	...
	public function loadImage(image:String, library:String = null) {
		frames = Paths.getSparrowAtlas(image, library);

		switch(image)
		{
			case 'campaign_menu_UI_characters':
			...
			case 'kapi-ui':
				animation.addByPrefix('kapi', 'Dad idle dance BLACK LINE', 24, false);
				animation.addByPrefix('gw', 'spooky dance idle BLACK LINES', 24, false);
		}
		
	}

	public function setCharacter(character:String, loadOffset:Bool = true):Void
	{
