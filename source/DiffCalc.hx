...
class DiffCalc
{
    ...
    public static function CalculateDiff(song:SwagSong, ?accuracy:Float = .93)
    {
        ...
        var firstNoteTime = (cleanedNotes[0] != null) ? cleanedNotes[0].strumTime : 0;
        ...
        // this is also fucking stupid -angel bot
        var length = (cleanedNotes[0] != null) ? ((cleanedNotes[cleanedNotes.length - 1].strumTime / 1000) / 0.5) : 0;
